...
consumerRouter.get('/fetchConsumerById/:id', Auth,controller.consumerController.fetchConsumerById)
...
consumerRouter.get('/fetchConsumerTypeById/:id', Auth,controller.consumerController.fetchConsumerTypeById)
